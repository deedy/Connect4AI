...
<html>
    <head>
        ...
        <script src=""""),_display_(Seq[Any](/*21.23*/routes/*21.29*/.Assets.at("javascripts/jquery-1.9.0.min.js"))),format.raw/*21.74*/("""" type="text/javascript"></script>
